...
#[derive(Parser, Debug)]
#[command(name = "matrix-discord-bridge")]
#[command(about = "Matrix-Discord Bridge", long_about = None)]
pub struct Cli {
    #[command(subcommand)]
...
pub enum Commands {
    ...
    GenerateRegistration {
        #[arg(short, long, default_value = "discord-registration.yaml")]
        output: PathBuf,
    ...
    ListRooms {
        #[arg(short, long, help = "Filter by guild ID")]
        guild: Option<String>,
