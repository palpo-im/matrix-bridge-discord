...
pub enum ProvisioningError {
    #[error("Timed out waiting for a response from the Discord owners.")]
    TimedOut,
    #[error("The bridge has been declined by the Discord guild.")]
    Declined,
    #[error("Could not send bridge permission request to Discord.")]
    DeliveryFailed,
