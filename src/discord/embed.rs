...
pub fn build_reply_embed(
    ...
    let mut embed = DiscordEmbed::new().description(preview);
...
mod tests {
    ...
    fn embed_to_json_includes_description() {
        let embed = DiscordEmbed::new().description("Hello world");
    ...
    fn embed_to_json_includes_author() {
        let embed = DiscordEmbed::new().author(EmbedAuthor {
    ...
    fn embed_to_json_includes_fields() {
        let embed = DiscordEmbed::new().field("Replying to Bob", "Hello...", false);
