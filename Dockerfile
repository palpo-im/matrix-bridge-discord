...
RUN cargo build --profile docker -p matrix-bridge-discord
...
COPY --from=builder /workspace/target/docker/matrix-bridge-discord /usr/local/bin/matrix-bridge-discord
